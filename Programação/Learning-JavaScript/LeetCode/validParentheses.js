...
/*  A complexidade temporal desse algoritmo é O(n). Já que para realização dele será necessário percorrer pela string s para que seja feita corretamente as validações.*/
